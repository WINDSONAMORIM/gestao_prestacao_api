...
import { ParamsMensalSubGrupo } from "../../../schemas/paramsShema.js";
import { ResponseAnaliseOrcamentariaAnualPorRubrica } from "../../../schemas/responseSchema.js";

export const resumoMensalPorRubrica = async (params: ParamsMensalSubGrupo): Promise<ResponseAnaliseOrcamentariaAnualPorRubrica[]> => {
    const response = await prisma.$queryRaw<ResponseAnaliseOrcamentariaAnualPorRubrica[]>`
        ...
        WHERE dt.ano = ${params.ano} AND dt.mes = ${params.mes}
